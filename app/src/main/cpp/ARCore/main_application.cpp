...
// in front of them.
    ...
    void MainApplication::OnResume(JNIEnv* env, void* context, void* activity) {
        LOGI("OnResume()");
    ...
    void MainApplication::OnDrawFrame(bool depthColorVisualizationEnabled,
    ...
    bool MainApplication::IsDepthSupported() {
    ...
    void MainApplication::ConfigureSession() {
    ...
    void MainApplication::OnSettingsChange(bool is_instant_placement_enabled) {
    ...
    void MainApplication::UpdateAnchorColor(ColoredAnchor* colored_anchor) {
...
// the camera feed. It takes into account device orientation.
    glm::mat3 MainApplication::GetTextureTransformMatrix(
